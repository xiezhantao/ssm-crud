            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">empName</label>
                        <div class="col-sm-10">
                            <p class="form-control-static" id="empName_updata_static">email@example.com</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">email</label>
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            ...
            function build_page_info(result){
                ...
                var totalCount = result.extend.pageInfo.total;
                currentPage = currentPageNum;
                $("#page_info_area").append("当前第"+currentPageNum+"页,共"+totalPage+"页,总共"+totalCount+"条记录")
            }
            ...
            function build_page_nav(result){
                ...
                if(result.extend.pageInfo.hasPreviousPage == false){
                    ...
                    prePageLi.click(function(){
                        var currentNum = result.extend.pageInfo.pageNum;
                        var target = currentNum - 1;
                        if (target <= 0){
                            target = 1;
                        }
                        to_page(target);
                ...
                if(result.extend.pageInfo.hasNextPage == false){
                    ...
                    lastPageLi.click(function(){
                        var lastNum = result.extend.pageInfo.pages;
                        to_page(lastNum)
                    });
            ...
            $("#empName_add_input").change(function(){
                //发送ajax请求校验用户名是否可用
                userName = $("#empName_add_input").val();
                $.ajax({
                    url: "${ctp}/checkuser",
                    type: "GET",
            ...
            $("#emp_save_btn").click(function(){
                ...
                //2、发送ajax请求保存员工
                dataContext = $("#empAddModal form").serialize();
                $.ajax({
                    url: "${ctp}/emp",
                    type: "POST",
                    data: dataContext,
            ...
            $(document).on("click",".delete_btn",function(){
                ...
                if(confirm("确认删除【"+empName+"】吗?")){
                    //确认，发送ajax请求删除即可
                    $.ajax({
                        url: "${ctp}/emp/"+$(this).attr("delete-id"),
                        type: "DELETE",
                        success: function(result){
                            alert(result.msg);
                            to_page(currentPage);
